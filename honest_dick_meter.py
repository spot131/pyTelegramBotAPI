...
low_number_phrases = [
    ...
    "ая пизанская башня",
    "ый немытый слесарь",
    "ый сломаный миноискатель",
    "ый невыполненный подвиг геракла",
    "ый пластиковый пират",
    "ый пучеглазый удильщик",
    "ый печальный конец",
    "ая палочка Коха",
    "ый ложный хуёнок",
    "ый клитор-переросток",
    "ый гландочëс",
    "ый седой влагалищевед",
    "ый пачкун трусниковый",
    "ый сопливый гусар",
    "ая сомнительная гордость"
