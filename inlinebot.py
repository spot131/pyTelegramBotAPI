...
BOT_USERNAME = "honest_dick_meterv2_bot"  # Replace with your bot's username (without @)

bot = telebot.TeleBot("8125063287:AAFFj83iAQSNmBVFeicaEmkW__UH5eWmHjE", parse_mode="HTML")  # Enable HTML parsing if needed
